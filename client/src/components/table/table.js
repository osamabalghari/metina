...
export function Table(props) {
	...
	return (
		<Fragment>
			{props.search && <Search className={Style.search} callback={search} throttle={props.throttle} />}
			<div className={Style.responsive}>
				<table className={!props.naked && tableStyle}>
					{header && <Header data={header} callback={sort} show={props.show} hide={props.hide} actions={props.actions} />}
					{body && (
						<Body
