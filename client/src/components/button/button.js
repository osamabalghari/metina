...
export function Button(props) {
	...
	return (
		<button
			...
			{props.icon ? (
				<Fragment>
					<Icon image={props.icon} pack={props.iconPack} color={props.iconColor || props.color} size={props.iconSize || props.size || 18} className={iconStyle + ' ' + props.background} />
