...
import {AuthContext, ViewContext, Form, Card, AccountNav, Button, useNavigate, Animate, useAPI, Event} from 'components/lib'
		...
		viewContext.modal.show(
			{
				...
				method: 'DELETE',
				destructive: true,
				text: 'Are you sure you want to delete your account? ' + 'You will lose all of your data and this can not be undone.'
			},
			() => {
				// destory user
