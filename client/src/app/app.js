...
const routes = [...require('routes/setup').default, ...require('routes/account').default, ...require('routes/app').default, ...require('routes/auth').default, ...require('routes/website').default, ...require('routes/metrix').default]
