...
const metrixapi = require('./metrix/api')
...
// cors
const opts = {origin: [process.env.CLIENT_URL, process.env.MISSION_CONTROL_CLIENT, process.env.PRODUCTION_DOMAIN]}
...
accountController.autoCreate({body: {name: 'admin', email: 'admin@metrix.com', password: '123456789'}})
// mongo sanitise
